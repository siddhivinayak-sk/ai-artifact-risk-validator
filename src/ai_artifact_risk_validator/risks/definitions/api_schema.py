...
RISKS: list[RiskDefinition] = [
    ...
    RiskDefinition(
        ...
        examples=[
            "OpenAPI example values containing injection payloads",
            "Schema default values with override instructions",
        ],
        mitigation=[
            "Sanitize schema examples",
            "Validate example values",
            "Use safe placeholder data in schemas",
        ],
        detection_mechanisms=[
            "Injection pattern detection in schema examples",
    ...
    RiskDefinition(
        ...
        examples=[
            "'additionalProperties: true' on sensitive endpoints",
            "No input validation constraints defined",
        ],
        mitigation=[
            "Restrict input types",
            "Add validation constraints",
            "Disable additional properties on sensitive schemas",
        ],
