...
RISKS: list[RiskDefinition] = [
    ...
    RiskDefinition(
        ...
        examples=[
            "Benchmark using production data as test input",
            "Eval results exposing internal system details",
        ],
        mitigation=[
            "Use synthetic test data",
            "Sanitize eval outputs",
            "Restrict eval result access",
        ],
    ...
    RiskDefinition(
        ...
        detection_mechanisms=[
            "Secret pattern detection in eval configs",
            "API key format matching",
        ],
    ...
    RiskDefinition(
        ...
        mitigation=[
            "Add coverage for all capability dimensions",
            "Include safety and robustness tests",
            "Implement adversarial benchmarks",
        ],
    ...
    RiskDefinition(
        ...
        mitigation=[
            ...
            "Pin model versions",
            "Document all evaluation parameters",
        ],
        detection_mechanisms=[
            "Reproducibility parameter check",
