...
RISKS: list[RiskDefinition] = [
    ...
    RiskDefinition(
        ...
        examples=["Stored conversation containing injection payload", "Memory entry with override instructions"],
        mitigation=["Sanitize memory content before context injection", "Validate stored entries", "Implement memory content filtering"],
        detection_mechanisms=["Injection pattern detection in stored content", "Semantic analysis of memory entries"],
    ...
    RiskDefinition(
        ...
        mitigation=["Scrub secrets from memory before persistence", "Implement secret detection in memory pipeline", "Encrypt sensitive memory entries"],
    ...
    RiskDefinition(
        ...
        mitigation=["Implement PII scrubbing", "Set retention limits for PII", "Apply data minimization principles"],
    ...
    RiskDefinition(
        ...
        examples=["Production data visible in dev context", "User A's data accessible in User B's session"],
        mitigation=["Implement context isolation for memory", "Enforce access boundaries", "Separate memory by security context"],
    ...
    RiskDefinition(
        ...
        mitigation=["Restrict memory file permissions", "Implement access control", "Encrypt memory at rest"],
    ...
    RiskDefinition(
        ...
        mitigation=["Implement memory size limits", "Add eviction policies", "Summarize old entries"],
    ...
    RiskDefinition(
        ...
        mitigation=["Implement memory expiration", "Add timestamp-based staleness detection", "Periodically review memory entries"],
