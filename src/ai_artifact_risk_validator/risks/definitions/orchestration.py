...
RISKS: list[RiskDefinition] = [
    ...
    RiskDefinition(
        ...
        examples=[
            "User input flowing through pipeline without sanitization",
            "Step output used as command argument",
        ],
        mitigation=[
            "Validate data between orchestration steps",
            "Implement input sanitization at step boundaries",
            "Use typed step interfaces",
        ],
        detection_mechanisms=[
            "Data flow analysis between steps",
            "Injection pattern detection in step definitions",
        ],
    ...
    RiskDefinition(
        ...
        mitigation=[
            "Apply per-step privilege levels",
            "Use minimum required permissions",
            "Implement step-level access control",
        ],
        detection_mechanisms=[
            "Privilege level analysis per step",
    ...
    RiskDefinition(
        ...
        examples=[
            ...
            "Retry loop without termination condition",
        ],
        mitigation=[
            "Validate DAG for cycles",
            "Add cycle detection",
            "Implement maximum execution limits",
        ],
